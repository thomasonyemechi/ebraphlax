                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/control/add_customer" method="POST" class="form-validate">@csrf

                                <div class="row">
                                    <div class="col-12">
                                        <div class="alert alert-warning">
                                            Please fill all out all the required field to create a new customer profile
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="d-flex  justify-content-end">
                                        <button type="submit" class="btn btn-primary btn-lg waves-effect waves-lightml-2">
                                            <i class="fa fa-save"></i> <span>Submit customer Info</span></button>
                                    </div>
                                </div>
                            </form>
                        </div>
